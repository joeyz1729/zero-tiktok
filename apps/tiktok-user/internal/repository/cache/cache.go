...
//
//const (
//	UserInfoPrefix  = "tiktok:tiktok-user:info:"  // hash
//	UserCountPrefix = "tiktok:tiktok-user:count:" // hash
//)
//
//const (
...
//)
//
//func (r *repository.Repo) AddCountCache(uid int64, user *repository.UserInfo) (err error) {
...
//}
//
//func (r *repository.Repo) AddDetailCache(uid int64, user *repository.UserInfo) (err error) {
//	pipeline := r.rdb.TxPipeline()
//	uidStr := strconv.FormatInt(uid, 10)
...
//func (r *repository.Repo) DelCountCache(userId, authorId int64) (err error) {
