...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.commentDo.UseModel(&pb.Comment{})
...
type ICommentDo interface {
	...
	Unscoped() ICommentDo
	Create(values ...*pb.Comment) error
	CreateInBatches(values []*pb.Comment, batchSize int) error
	Save(values ...*pb.Comment) error
	First() (*pb.Comment, error)
	Take() (*pb.Comment, error)
	Last() (*pb.Comment, error)
	Find() ([]*pb.Comment, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*pb.Comment, err error)
	FindInBatches(result *[]*pb.Comment, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*pb.Comment) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*pb.Comment, error)
	FirstOrCreate() (*pb.Comment, error)
	FindByPage(offset int, limit int) (result []*pb.Comment, count int64, err error)
...
func (c commentDo) Create(values ...*pb.Comment) error {
	if len(values) == 0 {
		return nil
	}
...
func (c commentDo) CreateInBatches(values []*pb.Comment, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c commentDo) Save(values ...*pb.Comment) error {
	if len(values) == 0 {
		return nil
	}
...
func (c commentDo) First() (*pb.Comment, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*pb.Comment), nil
	}
}

func (c commentDo) Take() (*pb.Comment, error) {
...
func (c commentDo) Last() (*pb.Comment, error) {
...
func (c commentDo) Find() ([]*pb.Comment, error) {
	result, err := c.DO.Find()
	return result.([]*pb.Comment), err
}

func (c commentDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*pb.Comment, err error) {
	buf := make([]*pb.Comment, 0, batchSize)
...
func (c commentDo) FindInBatches(result *[]*pb.Comment, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c commentDo) FirstOrInit() (*pb.Comment, error) {
...
func (c commentDo) FirstOrCreate() (*pb.Comment, error) {
...
func (c commentDo) FindByPage(offset int, limit int) (result []*pb.Comment, count int64, err error) {
...
func (c commentDo) Delete(models ...*pb.Comment) (result gen.ResultInfo, err error) {
