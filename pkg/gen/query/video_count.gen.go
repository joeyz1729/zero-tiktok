...
func newVideoCount(db *gorm.DB, opts ...gen.DOOption) videoCount {
	...
	_videoCount.videoCountDo.UseModel(&pb.VideoCount{})

	tableName := _videoCount.videoCountDo.TableName()
	_videoCount.ALL = field.NewAsterisk(tableName)
	_videoCount.ID = field.NewInt64(tableName, "id")
	_videoCount.ThumbupCount = field.NewInt64(tableName, "thumbup_count")
	_videoCount.CommentCount = field.NewInt64(tableName, "comment_count")
	_videoCount.CreateTime = field.NewTime(tableName, "create_time")
	_videoCount.UpdateTime = field.NewTime(tableName, "update_time")
...
type videoCount struct {
	videoCountDo videoCountDo

	ALL          field.Asterisk
	ID           field.Int64
	ThumbupCount field.Int64
...
func (v *videoCount) updateTableName(table string) *videoCount {
	...
	v.ThumbupCount = field.NewInt64(table, "thumbup_count")
...
func (v *videoCount) WithContext(ctx context.Context) IVideoCountDo {
	return v.videoCountDo.WithContext(ctx)
}

func (v videoCount) TableName() string { return v.videoCountDo.TableName() }

func (v videoCount) Alias() string { return v.videoCountDo.Alias() }

func (v videoCount) Columns(cols ...field.Expr) gen.Columns { return v.videoCountDo.Columns(cols...) }
...
func (v *videoCount) fillFieldMap() {
	...
	v.fieldMap["id"] = v.ID
	v.fieldMap["thumbup_count"] = v.ThumbupCount
...
type IVideoCountDo interface {
	...
	Create(values ...*pb.VideoCount) error
	CreateInBatches(values []*pb.VideoCount, batchSize int) error
	Save(values ...*pb.VideoCount) error
	First() (*pb.VideoCount, error)
	Take() (*pb.VideoCount, error)
	Last() (*pb.VideoCount, error)
	Find() ([]*pb.VideoCount, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*pb.VideoCount, err error)
	FindInBatches(result *[]*pb.VideoCount, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*pb.VideoCount) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*pb.VideoCount, error)
	FirstOrCreate() (*pb.VideoCount, error)
	FindByPage(offset int, limit int) (result []*pb.VideoCount, count int64, err error)
...
func (v videoCountDo) Create(values ...*pb.VideoCount) error {
	if len(values) == 0 {
		return nil
	}
...
func (v videoCountDo) CreateInBatches(values []*pb.VideoCount, batchSize int) error {
	return v.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (v videoCountDo) Save(values ...*pb.VideoCount) error {
	if len(values) == 0 {
		return nil
	}
...
func (v videoCountDo) First() (*pb.VideoCount, error) {
	if result, err := v.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*pb.VideoCount), nil
	}
}

func (v videoCountDo) Take() (*pb.VideoCount, error) {
...
func (v videoCountDo) Last() (*pb.VideoCount, error) {
...
func (v videoCountDo) Find() ([]*pb.VideoCount, error) {
	result, err := v.DO.Find()
	return result.([]*pb.VideoCount), err
}

func (v videoCountDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*pb.VideoCount, err error) {
	buf := make([]*pb.VideoCount, 0, batchSize)
...
func (v videoCountDo) FindInBatches(result *[]*pb.VideoCount, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (v videoCountDo) FirstOrInit() (*pb.VideoCount, error) {
...
func (v videoCountDo) FirstOrCreate() (*pb.VideoCount, error) {
...
func (v videoCountDo) FindByPage(offset int, limit int) (result []*pb.VideoCount, count int64, err error) {
...
func (v videoCountDo) Delete(models ...*pb.VideoCount) (result gen.ResultInfo, err error) {
