...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.videoDo.UseModel(&pb.Video{})
...
type IVideoDo interface {
	...
	Unscoped() IVideoDo
	Create(values ...*pb.Video) error
	CreateInBatches(values []*pb.Video, batchSize int) error
	Save(values ...*pb.Video) error
	First() (*pb.Video, error)
	Take() (*pb.Video, error)
	Last() (*pb.Video, error)
	Find() ([]*pb.Video, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*pb.Video, err error)
	FindInBatches(result *[]*pb.Video, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*pb.Video) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*pb.Video, error)
	FirstOrCreate() (*pb.Video, error)
	FindByPage(offset int, limit int) (result []*pb.Video, count int64, err error)
...
func (v videoDo) Create(values ...*pb.Video) error {
	if len(values) == 0 {
		return nil
	}
...
func (v videoDo) CreateInBatches(values []*pb.Video, batchSize int) error {
	return v.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (v videoDo) Save(values ...*pb.Video) error {
	if len(values) == 0 {
		return nil
	}
...
func (v videoDo) First() (*pb.Video, error) {
	if result, err := v.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*pb.Video), nil
	}
}

func (v videoDo) Take() (*pb.Video, error) {
...
func (v videoDo) Last() (*pb.Video, error) {
...
func (v videoDo) Find() ([]*pb.Video, error) {
	result, err := v.DO.Find()
	return result.([]*pb.Video), err
}

func (v videoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*pb.Video, err error) {
	buf := make([]*pb.Video, 0, batchSize)
...
func (v videoDo) FindInBatches(result *[]*pb.Video, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (v videoDo) FirstOrInit() (*pb.Video, error) {
...
func (v videoDo) FirstOrCreate() (*pb.Video, error) {
...
func (v videoDo) FindByPage(offset int, limit int) (result []*pb.Video, count int64, err error) {
...
func (v videoDo) Delete(models ...*pb.Video) (result gen.ResultInfo, err error) {
